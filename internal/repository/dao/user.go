 ...
 * @FilePath: /go/src/webook/internal/repository/dao/user.go
 * @Description:
 *
 ...
 * @return {error}
 */
func (u *UserDAO) Insert(ctx context.Context, user User) (User, error) {
...
func (u *UserDAO) FindById(ctx context.Context, id uint64) (User, error) {
	var user User
 ...
 * @return {Profile, error}
 */
func (u *UserDAO) InsertProfile(ctx context.Context, user User, profile Profile) (Profile, error) {
 ...
 * @return {Profile, error}
 */
func (u *UserDAO) UpdateProfile(ctx context.Context, profile Profile) (Profile, error) {
