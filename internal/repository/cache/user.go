 ...
 * @FilePath: /go/src/webook/internal/repository/cache/user.go
 * @Description: 缓存取用户
 *
 ...
 */
func (u *UserCache) FindUserById(ctx context.Context, id uint64) (dao.User, error) {
 ...
 */
func (u *UserCache) FindUserByEmail(ctx context.Context, email string) (dao.User, error) {
 ...
 * @return {dao.Profile}
 */
func (u *UserCache) FindProfileByUser(ctx context.Context, user dao.User) (dao.Profile, error) {
 ...
 * @return {error}
 */
func (u *UserCache) SetUser(ctx context.Context, user dao.User) error {
 ...
 * @return {error}
 */
func (u *UserCache) SetProfile(ctx context.Context, profile dao.Profile) error {
 ...
 * @return {string}
 */
func (u *UserCache) getUserCacheKey(id uint64) string {
	return fmt.Sprintf("webook:user:getusercachekey:%d", id)
}
func (u *UserCache) getUserCacheEmailKey(email string) string {
	return fmt.Sprintf("webook:user:getusercacheemailkey:%s", email)
}
func (u *UserCache) getProfileCacheUserKey(userId uint64) string {
